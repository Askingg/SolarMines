...
public class Core {
	...
	public static String central(String message) {
        ...
        for (int length = (charArray = message.toCharArray()).length, i = 0; i < length; ++i) {
            ...
            if (c == '§') {
                ...
                final CharLength dFI = CharLength.getDefaultFontInfo(c);
                messagePxSize += (isBold ? dFI.getBoldLength() : dFI.getLength());
                ++messagePxSize;
            }
        }
        final int halvedMessageSize = messagePxSize / 2;
        final int toCompensate = 175 - halvedMessageSize;
        final int spaceLength = CharLength.SPACE.getLength() + 1;
        int compensated = 0;
	...
	public static String longToDateDate(long milis) {
	...
	public static String timeOneUnit(int seconds) {
		if (seconds < 60) {
			return seconds + "s";
		}
		int minutes = seconds / 60;
